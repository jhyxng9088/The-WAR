...
export class DiagnosticsOverlay {
  ...
  private renderMetrics(): void {
    ...
    this.metrics.textContent =
      this.fps + " fps · " + width + "×" + height +
      " · DPR " + pixelRatio.toFixed(2) + " · diagnostic surface";
  }
}
